...
| Launcher | In progress (v0.13.1) — identity (+ game handoff), multi-channel install/update, self-update, Windows firewall prompt, manual per-channel update check under the channel selector; see `LauncherChangeLog.md` |
